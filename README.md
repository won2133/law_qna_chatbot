...
## 유사도의 정확성 높이기
* 이 이전에 수행했던 판례 추천 프로젝트(precedent_recommand)의 문제점 중 하나인 판례 추천 결과의 신뢰성을 위해 정확도를 계산하고 높여야 했다. 우선 판례와 관련된 질문이 있는 데이터를 확보했으니, 정확도를 높이기 위해 다양한 형태소 분석기와 임베딩 모델 등을 비교하였다.
